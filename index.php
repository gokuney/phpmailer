...
$mail->Username = "raghavguptastepup@gmail.com";
//Password to use for SMTP authentication
$mail->Password = "raghav@stepup";
//Set who the message is to be sent from
$mail->setFrom('noreply@aayaamlabs.com', 'AayaamLabs');
...
$mail->msgHTML(file_get_contents('mailtemplate.html'), dirname(__FILE__));
//Replace the plain text body with one created manually
$mail->AltBody = 'This is for plain text';
